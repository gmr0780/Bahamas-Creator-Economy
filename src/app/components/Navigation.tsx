  ...
  return (
    ...
    >
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-8">
        ...
        <button
          type="button"
          className="md:hidden relative z-50 flex h-10 w-10 items-center justify-center rounded-lg text-navy"
          ...
          <div className="flex flex-col items-center justify-center h-full gap-8">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-2xl font-semibold text-navy transition-colors hover:text-aqua"
